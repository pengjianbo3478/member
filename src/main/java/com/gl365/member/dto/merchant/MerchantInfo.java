...
public class MerchantInfo implements Serializable {
	...
	public Short getHotLevel() {
		return hotLevel;
	}

	public void setHotLevel(Short hotLevel) {
	...
	public Short getOperatorCount() {
		return operatorCount;
	}

	public void setOperatorCount(Short operatorCount) {
